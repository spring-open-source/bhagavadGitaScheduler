  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
          <h1 class="text-center font-weight-bold" style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center">Unsubscribed!</h1>
...
<div class="text-center text-muted  " style="color: #636c72;" align="center">Jai Shree Krishna, You Have Been Successfully Unsubscribed From Daily Bhagvad Gita Verse Service, You Will No Longer Recieve Mails From Us.
          </div>
<table class="s-1 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
...
<div class="text-center text-muted  " style="color: #636c72;" align="center">This Project Is Created By Hardik Singh Behl, You Can View The Repository By Clicking The Link Below And Show Some Love By Giving The Repo A Star
          </div>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#343a40">
        <a href="https://www.github.com/hardikSinghBehl/bhagvadGita" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #343a40; color: #ffffff; padding: 8px 12px; border: 1px solid #343a40;">Github Link Of Project</a>
      </td>
    </tr>
  </tbody>
</table>
