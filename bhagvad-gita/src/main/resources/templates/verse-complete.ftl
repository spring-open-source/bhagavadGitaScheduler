...
<table class="card  bg-light" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; width: 100%; overflow: hidden; border: 1px solid #dee2e6;" bgcolor="#f8f9fa">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left" bgcolor="#f8f9fa">
        <div>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
        <div>
          <h1 class="text-center font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center">All Verses Complete!</h1>
    ...
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
          ...
          <p class="text-muted  text-center" style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; margin: 0;" align="center">Thank You For Subscribing To Our Service, We Hope You Enjoyed Your Daily Dose Of Bhagvad Gita Verse, Delivered To You Each And Every Day For The Past 2 Years And 2 Months.</p>
  ...
  <tbody>
    <tr>
      <td height="8" style="border-spacing: 0px; border-collapse: collapse; line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;" align="left">
        ...
        <p class="text-center font-weight-bold " style="line-height: 24px; font-size: 16px; font-weight: bold !important; width: 100%; margin: 0;" align="center">-- Jai Shree Murli Manohar Banke Bihari Radhe Krishna  --</p>
<table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
         
         ...
         <p class="text-muted  text-center" style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; margin: 0;" align="center">Everything Was Created By Hardik Singh Behl, He Says He Doesn't Like To Brag, But Wants You To Know That He Is THE Best</p>
    ...
    <tr>
      <td height="24" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;" align="left">
       ...
       <div class="text-center" style="" align="center">
          <table class="btn btn-dark " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#343a40">
        <a href="https://www.github.com/hardikSinghBehl" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #343a40; color: #ffffff; padding: 8px 12px; border: 1px solid #343a40;">Github Link</a>
      </td>
    </tr>
  </tbody>
</table>
